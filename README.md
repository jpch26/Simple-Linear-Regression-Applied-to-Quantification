...
You can the presentation for this tutorial by cliking on: [Simple Linear Regression Applied to Quantification](https://r-inthelab.net/2021/02/01/simple-linear-regression-applied-to-quantification/).
